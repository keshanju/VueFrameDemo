...
export default class JumpWebUtil {
    ...
    public static HTML_NAME_BUSINESS ='business.html' //商务合作
    public static HTML_NAME_JOIN ='join.html' //加入我们
    ...
    public static HTML_NAME_SUPPORT = 'gamesupport.html'; // 会员服务条款

    public static HTML_NAME_DETAILS_NEWS = 'news'; // 资讯详情页 + id
    public static HTML_NAME_DETAILS_NOTICE = 'notice'; // 公告详情页 + id
    public static HTML_NAME_DETAILS_ACTIVITY = 'activity'; // 活动详情页 + id
    ...
    public static changeCn() {
        ...
        if (origin.indexOf('cn.') != -1 && pathname.indexOf('/en') != -1) {
            ...
            LocalStorageUtil.addLanguage(Util.CN);
    ...
    public static changeEn() {
        ...
        if (origin.indexOf('cn.') != -1 && pathname.indexOf('/en') == -1) {
            ...
            LocalStorageUtil.addLanguage(Util.EN);
            window.location.href = url + search;
        } else if (origin.indexOf('www.') != -1 && pathname.indexOf('/cn') !== -1) {
            //如果是www的国外网站,且找到/cn
    ...
    public static changeEn_0() {
        ...
        if (pathname.indexOf('/' + Util.REGION_CODE_INTL) == -1 && pathname.indexOf('/' + Util.REGION_CODE_0) == -1) {
            ...
            if (origin != undefined) url = url + origin;
            url = url + '/' + Util.REGION_CODE_INTL + '/en' + pathname;
        }
        //设置cookie，防止语言跳转
        LocalStorageUtil.addLanguage(Util.EN);
        window.location.href = url + search;
