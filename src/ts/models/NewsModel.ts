...
export class NewRequestModel {
  ...
  public project? :number=undefined; //0-薄荷；1-雷神；
  public size: number = 5;
 ...
 * 活动详情请求参数
 */
export class ActivityPackageRequestModel {
    public account_token?: string = "";
    public activity_id: number = 0;
    public region_code?: number;
    public lang: string = '';
...
export class ActivityPictureModel {
  ...
  public imgs: [{ key: number; img_url: string }]; //返回所有平台的图片 0 是官网登陆页面  1是移动端登录  2pc 客户端登录  3 官网首页banner  4 用户中心  5 充值中心
  public title: string = ""; //活动名
  public url: string = ""; //pc 端活动链接
  public m_url: string = ""; //移动端活动链接
  public url_type: number; //0 不是单独的专题  1是单独专题页面
  public img_3?:string='';
  public start_time:string = '';//活动开始时间
  public end_time:string = '';//活动结束时间
  public now_time:string = '';//当前时间
