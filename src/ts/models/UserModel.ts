...
export class PhoneRegisterRequestModel {
    ...
    public src_channel: string = '';//渠道来源
}
...
export class UserInfo {
    ...
    public static getUserName(userInfo: UserInfo) {
        ...
        // 根据用户是否是付费用户，判断显示是超级会员还是免费体验
        userInfo.package_title = (userInfo.is_pay_user==0?'免费体验':userInfo.package_title);
    ...
    public static updateUserInfo(
        ...
        if (userInfo != null) {
            ...
            updateInfo.region_code = userInfo.region_code;
...
export class payTransfer {
    public price_title: string = "";
    public price_num: string = "";
    public zheCodeList:Array<{label:string,value:string}>=[]
}
/**
 * 用户活动 - 奖品列表-请求参数
 */
...
export class ActiveRecordModel {
    ...
    discount_expired_time:string='';
    card_package: Array<ActiveRecordBox> = []
}
 export class ActiveRecordBox{
    id:string='';
    title:string=''
 }
/**
